...
class CompanyOnboarding(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("company_id", name="uq_company_onboarding_company"),)
    ...
    def is_complete(self) -> bool:
        return all([self.has_profile, self.has_team_member, self.has_system, self.has_agent_run])
