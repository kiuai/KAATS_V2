...
@router.get(
    "/admin/enterprises", response_model=list[EnterpriseRead], dependencies=[platform_admin_only]
)
...
@router.post(
    "/companies", response_model=CompanyRead, status_code=201, dependencies=[can_manage_company]
)
...
@router.get(
    "/companies/{company_id}", response_model=CompanyRead, dependencies=[can_manage_company]
)
